...
console.log('mon prénom', firstName, 'est de type', typeof name);
console.log('mon age', age, 'est de type', typeof age);
console.log('mon gout pour le football', likeFootball, 'est de type', typeof likeFootball);
console.log('mon autre variable', otherStuff, 'est de type', typeof otherStuff);
...
function sayHello(name){
    ...
    return;
    console.log(name, "salut");
}

sayHello('Sourour');
sayHello('Jean Philippe');
